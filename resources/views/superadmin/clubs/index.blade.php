                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 class-left text-xs font-bold text-gray-500 uppercase tracking-wider">Módulos Activos (SaaS)</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-10 text-center text-gray-500 italic">No hay clubes registrados en la plataforma.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
